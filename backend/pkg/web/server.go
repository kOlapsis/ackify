...
import (
	...
	"github.com/kolapsis/ackify/backend/internal/infrastructure/auth"
	...
	"github.com/kolapsis/ackify/backend/internal/infrastructure/webhook"
	"github.com/kolapsis/ackify/backend/internal/infrastructure/workers"
	"github.com/kolapsis/ackify/backend/internal/presentation/api"
	"github.com/kolapsis/ackify/backend/internal/presentation/api/shared"
	"github.com/kolapsis/ackify/backend/internal/presentation/handlers"
	...
	webauth "github.com/kolapsis/ackify/backend/pkg/web/auth"

	sdk "github.com/kolapsis/shm/sdk/golang"
)
...
func (b *ServerBuilder) buildRouter(repos *repositories, whPublisher *services.WebhookPublisher) *chi.Mux {
	...
	apiConfig := api.RouterConfig{
		...
		BaseURL:              b.cfg.App.BaseURL,
		AllowedRedirectHosts: b.cfg.App.AllowedRedirectHosts,
